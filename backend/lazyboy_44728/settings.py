"""
Django settings for lazyboy_44728 project.
...
ROOT_URLCONF = 'lazyboy_44728.urls'
...
WSGI_APPLICATION = 'lazyboy_44728.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lazyboy_44728 API",
    "DESCRIPTION": "API documentation for lazyboy_44728 App",
    "VERSION": "v1",
}
